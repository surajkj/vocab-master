...
export default defineConfig({
    ...
    base: process.env.GITHUB_PAGES ? '/vocab-master/' : '/vocab-master/',
    ...
    plugins: [
        ...
        VitePWA({
            ...
            manifest: {
                ...
                display: 'standalone',
                start_url: process.env.GITHUB_PAGES ? '/vocab-master/' : '/vocab-master/',
                scope: process.env.GITHUB_PAGES ? '/vocab-master/' : '/vocab-master/',
                icons: [
                    {
                        src: 'pwa-192x192.png',
                        sizes: '192x192',
            ...
            workbox: {
                ...
                navigateFallback: '/vocab-master/index.html',
